      ...
      <Grid container spacing={2} wrap="wrap">
        ...
        <Grid item xs={10} md={10} >
          {!user ?  
            <>
              <h1>Welcome!</h1>
              <p> This app is designed to help you cook nutritious, wholesome, affordable food and reduce food waste.
              <br></br>
              <br></br>
          ...
          <div>
            {canceled ? <Redirect to="/canceled"/> : <Route to="/"/>}
            {success ? <Redirect to="/success"/> : <Route to="/"/>}
          </div>
